...
if __name__ == "__main__":
    ...
    algo = DoubleQLearning(S,A,env) # to comment after training

    # algo = DoubleQLearning(S,A,env,PATH_MODEL_A,PATH_MODEL_B) # to uncomment after training

    algo.learning() # to comment after training

    algo.save_model(PATH_MODEL_A,PATH_MODEL_B) # to comment after training
